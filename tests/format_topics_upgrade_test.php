...
/**
 * format_default unit tests for upgradelib
 *
...
require_once($CFG->dirroot . '/course/format/default/db/upgradelib.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_default_upgrade_testcase extends advanced_testcase {
    ...
    public function test_numsections_no_actions() {
        ...
        $DB->insert_record('course_format_options', ['courseid' => $course->id, 'format' => 'default',
        ...
        format_default_upgrade_remove_numsections();
    ...
    public function test_numsections_delete_empty() {
        ...
        $params1 = array('format' => 'default', 'numsections' => 5, 'startdate' => 1445644800);
        $course1 = $this->getDataGenerator()->create_course($params1);
        $params2 = array('format' => 'default', 'numsections' => 20, 'startdate' => 1445644800);
        ...
        $DB->insert_record('course_format_options', ['courseid' => $course1->id, 'format' => 'default',

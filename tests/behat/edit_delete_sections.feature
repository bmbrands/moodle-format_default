...
Feature: Sections can be edited and deleted in default format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete default
  ...
  @javascript
  Scenario: Inline edit section name in default format
  ...
  Scenario: Deleting the last section in default format
  ...
  Scenario: Deleting the middle section in default format

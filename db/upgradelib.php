...
/**
 * Upgrade scripts for course format "default"
 *
...
/**
 * This method finds all courses in 'default' format that have actual number of sections
 * bigger than their 'numsections' course format option.
 * For each such course we call {@link format_default_upgrade_hide_extra_sections()} and
 * either delete or hide "orphaned" sections.
 */
function format_default_upgrade_remove_numsections() {
    global $DB;
    ...
    $params = ['format1' => 'default', 'format2' => 'default', 'numsections' => 'numsections'];
    ...
    foreach ($needfixing as $courseid => $numsections) {
        format_default_upgrade_hide_extra_sections($courseid, $numsections);
    }

    $DB->delete_records('course_format_options', ['format' => 'default', 'sectionid' => 0, 'name' => 'numsections']);
}
 ...
 */
function format_default_upgrade_hide_extra_sections($courseid, $numsections) {
    global $DB;
